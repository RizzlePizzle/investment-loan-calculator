# 📱 Polished & Mobile-Responsive Investment Loan Calculator with Bank Comparison
...
st.title("📊 Property Investment Loan Calculator with Bank Comparison")
...
# Bank Proposal Simulation
bank_home_loan = 270000
bank_home_rate = owner_rate
bank_invest_loan = 480000
bank_invest_rate = invest_rate
...
st.markdown("---")
st.caption("Compare your custom equity-based loan strategy to the bank’s proposal. Adjust inputs above.")
